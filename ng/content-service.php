<article id="post-<?php the_ID(); ?>" <?php post_class('blog-card'); ?>>
	...
	<div class="blog-card-inner service">
		...
		<div class="blog-card-right">
            ...
            <?php if (!empty(get_field('service_gallery'))): ?>
            <div class="service-gallery">
                <?php foreach (get_field('service_gallery') as $row):?>
                    <div class="item">
                        <a href="<?= $row['url'] ?>" data-fancybox="gallery">
                            <img src="<?= $row['sizes']['thumbnail'] ?? $row['url'] ?>">
                        </a>
                    </div>
                <?php endforeach; ?>
            </div>
